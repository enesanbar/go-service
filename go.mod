module github.com/enesanbar/go-service
...
require (
	...
	github.com/instana/go-sensor/instrumentation/instaecho v1.28.1
...
require (
	github.com/instana/go-sensor/instrumentation/instamongo v1.28.1
